...
# right side of the tail was photographed in some individuals i.e. their landmarks appear reflected over x axis
...
## pairwise comparison for size using the pairwsie() function
